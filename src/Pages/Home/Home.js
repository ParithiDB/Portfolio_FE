...
function Home(props) {
    return (
        ...
        <div className='container'>
            <div>
            <h4 className='hello-world'>Hello, World!</h4>
            </div>
            <div>
            <h1 className='name'>I'm <span className='first-letter name'>P</span>arithi.</h1>
            </div>
            <div>
    ...
    <h2 class="accordion-header">
      <button class="accordion-button collapsed more" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
        <p className='m-0'>More About Me</p> 
      </button>
    </h2>
    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <p>Hey there, I'm Parithi D B, MERN - Full Stack Developer and Design Wizard! I spin code into web wonders and sprinkle design magic to create digital experiences that are as functional as they are visually enchanting.</p>
      </div>
    </div>
  </div>
  </div>
