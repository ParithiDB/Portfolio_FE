...
function AboutMe(props) {
    ...
    return (
        <div className='about'>
            ...
            <div className='row'>
                <div className='col-12 col-md-4 profile me-5 mb-4'>
                    <div className='image m-3'>
                        <img src='/Assests/bgg.JPG' alt='profile' height={200} width={200} className='pro-image'/>
                    </div>
                    <div className='profile-info'>
                        <h1>PARITHI D B</h1>
                        <p className='fsd'>Full Stack Developer</p>
                        <div className='social-linkss'>
         <Link to='https://github.com/ParithiDB' target='_blank'><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 48 48">
...
<Link to='https://in.linkedin.com/' target='_blank'><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 64 64">
...
<Link to='https://gmail.com/' target='_blank'><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 48 48">
<path fill="#4caf50" d="M45,16.2l-5,2.75l-5,4.75L35,40h7c1.657,0,3-1.343,3-3V16.2z"></path><path fill="#1e88e5" d="M3,16.2l3.614,1.71L13,23.7V40H6c-1.657,0-3-1.343-3-3V16.2z"></path><polygon fill="#e53935" points="35,11.2 24,19.45 13,11.2 12,17 13,23.7 24,31.95 35,23.7 36,17"></polygon><path fill="#c62828" d="M3,12.298V16.2l10,7.5V11.2L9.876,8.859C9.132,8.301,8.228,8,7.298,8h0C4.924,8,3,9.924,3,12.298z"></path><path fill="#fbc02d" d="M45,12.298V16.2l-10,7.5V11.2l3.124-2.341C38.868,8.301,39.772,8,40.702,8h0 C43.076,8,45,9.924,45,12.298z"></path>
</svg></Link>
         </div>
         <button type="button" class="btn btn-success mt-2" onClick={handleDownloadResume} style={{borderRadius:'32px'}}>Download Resume</button>
                    </div>
                </div>
                <div className='col-12 col-md-7'>
                    <div className='aboutme mb-2'>
                    <h3 className='name-color'>HELLO! I'M <span>P</span>ARITHI</h3>
                    <p>Hey there! I'm Parithi, a passionate and dedicated full stack developer with a flair for crafting elegant and efficient solutions to complex problems. With a background in both front-end and back-end development, I thrive on the thrill of turning ideas into functional, user-friendly applications.</p>
                    {/* <h5>What I do?</h5>
                    <p>I specialize in building dynamic web applications that seamlessly integrate the user experience with powerful functionality. From conceptualization to deployment, I'm involved in every step of the development process. I have a keen eye for detail and a drive to create polished, responsive designs that engage users across all devices.</p> */}
                </div>
                <div className='aboutme'>
                    <h5>My Skills</h5>
                    <p className='m-0'>I am a Full Stack Developer, specializing in both <b>Backend & Frontend</b> development.</p>
                    <p>On the front end, I'm skilled in <b>HTML, CSS, and JavaScript,</b> utilizing frameworks like <b>React</b> to bring designs to life. I understand the importance of user-centric design and strive to create interfaces that are not only visually appealing but also intuitive and easy to navigate.
When it comes to the back end, I'm experienced in server-side programming using technologies like <b>Node.js</b>. I work with databases such as <b>MongoDB</b> to ensure that data is stored securely and efficiently.</p>
                </div>
                </div>
            </div>
        </div>
